		...
		<div class="nav-menu">			
			...
			<nav class="menu-list">
			  <ul class="clearfix">
				...
				<li<?php if ($page == 'Rechercher') {echo ' class="active"';} ?> ><a href="rechercher.php">Rechercher</a></li>
				<li<?php if ($page == 'S\'orienter') {echo ' class="active"';} ?> ><a href="s-orienter.php"><span class="premium-tag">Premium</span> S'orienter</a></li>
